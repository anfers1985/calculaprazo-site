...
// Troque pela URL real da sua Edge Function depois do deploy no Supabase
// (Project Settings → API → Project URL, + /functions/v1/newsletter-subscribe)
...
function newsletterSubscribe(e) {
  ...
  const website = form.website.value; // honeypot anti-spam
  const msgEl = document.getElementById('nl-signup-msg');
