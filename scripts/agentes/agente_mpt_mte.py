...
Existe alguma notícia, portaria ou informação relevante para advogados trabalhistas, RH ou contadores?
...
def main():
    print(f"\nAgente MPT/MTE — {HOJE.strftime('%d/%m/%Y')}")
    print("=" * 50)
    ...
    print(f"\n{'='*50}")
    print(f"Total publicado: {publicados} artigo(s) do MPT/MTE.")
